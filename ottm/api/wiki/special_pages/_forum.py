"""This module defines the forum special page."""
...
class ForumSpecialPage(_core.SpecialPage):
    """This special page is the wiki’s forum."""

    def __init__(self):
        super().__init__('Forum', accesskey='m', category=_core.Section.LOGS)
