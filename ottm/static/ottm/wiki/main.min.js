"use strict";(function(){class Config{#mappings;constructor(){this.#mappings=window.WIKI_CONFIG;delete window.WIKI_CONFIG;$("#wiki-config-script").remove();}
...
window.WIKI_CONFIG={a:1,b:2};window.wiki={Config:Config,config:new Config(),};$(".hljs").each((_,element)=>hljs.highlightElement(element));})();