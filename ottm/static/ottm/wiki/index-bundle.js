...
/* harmony export */   "default": () => (/* binding */ hookExitConfirm)
/* harmony export */ });
...
function hookExitConfirm(form) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea, select", form).on("change keyup", () => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DistinctPipeline: () => (/* binding */ DistinctPipeline),
/* harmony export */   FilterPipeline: () => (/* binding */ FilterPipeline),
/* harmony export */   FlatMapPipeline: () => (/* binding */ FlatMapPipeline),
/* harmony export */   LimitPipeline: () => (/* binding */ LimitPipeline),
/* harmony export */   MapPipeline: () => (/* binding */ MapPipeline),
/* harmony export */   PeekPipeline: () => (/* binding */ PeekPipeline),
/* harmony export */   SkipPipeline: () => (/* binding */ SkipPipeline),
/* harmony export */   SortedPipeline: () => (/* binding */ SortedPipeline),
/* harmony export */   SourcePipeline: () => (/* binding */ SourcePipeline)
/* harmony export */ });
...
var _SourcePipeline_closed, _FilterPipeline_predicate, _MapPipeline_mapper, _FlatMapPipeline_mapper, _DistinctPipeline_seenValues, _SortedPipeline_instances, _SortedPipeline_comparator, _SortedPipeline_sortedValues, _SortedPipeline_hasSorted, _SortedPipeline_closed, _SortedPipeline_sort, _SortedPipeline_insert, _PeekPipeline_action, _LimitPipeline_maxSize, _LimitPipeline_nbSeen, _SkipPipeline_n, _SkipPipeline_nbSkipped;
/**
...
class SourcePipeline {
    ...
    constructor(iterable) {
        this.mayChangeNumberOfElements = false;
        /**
         * Indicate whether this pipeline has been closed.
         */
        _SourcePipeline_closed.set(this, false);
        this.iterable = iterable;
    }
    *[(_SourcePipeline_closed = new WeakMap(), Symbol.iterator)]() {
        for (const e of this.iterable) {
            if (__classPrivateFieldGet(this, _SourcePipeline_closed, "f")) {
                break;
            }
            yield e;
        }
    ...
    close() {
        __classPrivateFieldSet(this, _SourcePipeline_closed, true, "f");
    }
}
/**
...
class FilterPipeline {
     ...
     */
    constructor(previousPipeline, predicate) {
        this.mayChangeNumberOfElements = true;
        /**
         * The predicate to check every value against.
         */
        _FilterPipeline_predicate.set(this, void 0);
        this.previousPipeline = previousPipeline;
        __classPrivateFieldSet(this, _FilterPipeline_predicate, predicate, "f");
    }
    *[(_FilterPipeline_predicate = new WeakMap(), Symbol.iterator)]() {
        for (const e of this.previousPipeline) {
            if (__classPrivateFieldGet(this, _FilterPipeline_predicate, "f").call(this, e)) {
                yield e;
            }
        }
        return null;
...
class MapPipeline {
     ...
     */
    constructor(previousPipeline, mapper) {
        this.mayChangeNumberOfElements = false;
        /**
         * The function to apply to every element.
         */
        _MapPipeline_mapper.set(this, void 0);
        this.previousPipeline = previousPipeline;
        __classPrivateFieldSet(this, _MapPipeline_mapper, mapper, "f");
    }
    *[(_MapPipeline_mapper = new WeakMap(), Symbol.iterator)]() {
        for (const e of this.previousPipeline) {
            yield __classPrivateFieldGet(this, _MapPipeline_mapper, "f").call(this, e);
        }
        return null;
    }
    close() {
...
class FlatMapPipeline {
    ...
    constructor(previousPipeline, mapper) {
         ...
         * The function to apply to every element.
         */
        _FlatMapPipeline_mapper.set(this, void 0);
        this.previousPipeline = previousPipeline;
        __classPrivateFieldSet(this, _FlatMapPipeline_mapper, mapper, "f");
    }
    *[(_FlatMapPipeline_mapper = new WeakMap(), Symbol.iterator)]() {
        for (const e of this.previousPipeline) {
            yield* __classPrivateFieldGet(this, _FlatMapPipeline_mapper, "f").call(this, e).toGenerator();
        }
        return null;
    }
    close() {
 ...
 */
class DistinctPipeline {
    /**
     * Create a new distinct pipeline.
     * @param previousPipeline The pipeline that precedes this one.
     */
    constructor(previousPipeline) {
        this.mayChangeNumberOfElements = true;
        /**
         * A set of all values that have already been seen.
         */
        _DistinctPipeline_seenValues.set(this, new Set());
        this.previousPipeline = previousPipeline;
    }
    *[(_DistinctPipeline_seenValues = new WeakMap(), Symbol.iterator)]() {
        for (const e of this.previousPipeline) {
            if (!__classPrivateFieldGet(this, _DistinctPipeline_seenValues, "f").has(e)) {
                __classPrivateFieldGet(this, _DistinctPipeline_seenValues, "f").add(e);
                yield e;
            }
        }
        return null;
    ...
    close() {
        this.previousPipeline.close();
        __classPrivateFieldGet(this, _DistinctPipeline_seenValues, "f").clear();
    }
}
/**
...
class SortedPipeline {
     ...
     */
    constructor(previousPipeline, comparator) {
        _SortedPipeline_instances.add(this);
        this.mayChangeNumberOfElements = false;
        /**
         * The comparator to use to sort elements.
         */
        _SortedPipeline_comparator.set(this, void 0);
        /**
         * The sorted list of all elements.
         */
        _SortedPipeline_sortedValues.set(this, []);
        /**
         * Indicate whether the elements have been sorted.
         */
        _SortedPipeline_hasSorted.set(this, false);
        /**
         * Indicate whether this pipeline has been closed.
         */
        _SortedPipeline_closed.set(this, false);
        this.previousPipeline = previousPipeline;
        __classPrivateFieldSet(this, _SortedPipeline_comparator, comparator !== null && comparator !== void 0 ? comparator : ((a, b) => {
            if (a === b) {
                return 0;
            }
            return a < b ? -1 : 1;
    ...
    *[(_SortedPipeline_comparator = new WeakMap(), _SortedPipeline_sortedValues = new WeakMap(), _SortedPipeline_hasSorted = new WeakMap(), _SortedPipeline_closed = new WeakMap(), _SortedPipeline_instances = new WeakSet(), Symbol.iterator)]() {
        if (!__classPrivateFieldGet(this, _SortedPipeline_hasSorted, "f")) {
            __classPrivateFieldGet(this, _SortedPipeline_instances, "m", _SortedPipeline_sort).call(this);
        }
        for (const e of __classPrivateFieldGet(this, _SortedPipeline_sortedValues, "f")) {
            if (__classPrivateFieldGet(this, _SortedPipeline_closed, "f")) {
                break;
            }
            yield e;
        }
    ...
    close() {
        this.previousPipeline.close();
        __classPrivateFieldGet(this, _SortedPipeline_sortedValues, "f").splice(0);
        __classPrivateFieldSet(this, _SortedPipeline_closed, true, "f");
    }
}
_SortedPipeline_sort = function _SortedPipeline_sort() {
    __classPrivateFieldSet(this, _SortedPipeline_hasSorted, true, "f");
    // Not using Array.sort() as it would require copying every values into an array before sorting it
    for (const e of this.previousPipeline) {
        __classPrivateFieldGet(this, _SortedPipeline_instances, "m", _SortedPipeline_insert).call(this, e);
    }
    this.previousPipeline.close();
}, _SortedPipeline_insert = function _SortedPipeline_insert(value) {
    for (let i = 0; i < __classPrivateFieldGet(this, _SortedPipeline_sortedValues, "f").length; i++) {
        const v = __classPrivateFieldGet(this, _SortedPipeline_sortedValues, "f")[i];
        if (__classPrivateFieldGet(this, _SortedPipeline_comparator, "f").call(this, value, v) < 0) { // value < v
            __classPrivateFieldGet(this, _SortedPipeline_sortedValues, "f").splice(i, 0, value);
            return;
        }
    }
    __classPrivateFieldGet(this, _SortedPipeline_sortedValues, "f").push(value);
};
/**
...
class PeekPipeline {
     ...
     */
    constructor(previousPipeline, action) {
        this.mayChangeNumberOfElements = false;
        /**
         * The function to apply to each element.
         */
        _PeekPipeline_action.set(this, void 0);
        this.previousPipeline = previousPipeline;
        __classPrivateFieldSet(this, _PeekPipeline_action, action, "f");
    }
    *[(_PeekPipeline_action = new WeakMap(), Symbol.iterator)]() {
        for (const e of this.previousPipeline) {
            __classPrivateFieldGet(this, _PeekPipeline_action, "f").call(this, e);
            yield e;
        }
        return null;
    }
...
class LimitPipeline {
     ...
     */
    constructor(previousPipeline, maxSize) {
        this.mayChangeNumberOfElements = true;
        /**
         * The maximum number of elements to iterate over.
         */
        _LimitPipeline_maxSize.set(this, void 0);
        /**
         * The total number of iterations.
         */
        _LimitPipeline_nbSeen.set(this, 0);
        if (maxSize < 0) {
            throw new Error("maxSize must be >= 0");
        }
        this.previousPipeline = previousPipeline;
        __classPrivateFieldSet(this, _LimitPipeline_maxSize, maxSize, "f");
    }
    *[(_LimitPipeline_maxSize = new WeakMap(), _LimitPipeline_nbSeen = new WeakMap(), Symbol.iterator)]() {
        var _a;
        for (const e of this.previousPipeline) {
            if (__classPrivateFieldGet(this, _LimitPipeline_nbSeen, "f") == __classPrivateFieldGet(this, _LimitPipeline_maxSize, "f")) {
                break;
            }
            __classPrivateFieldSet(this, _LimitPipeline_nbSeen, (_a = __classPrivateFieldGet(this, _LimitPipeline_nbSeen, "f"), _a++, _a), "f");
            yield e;
        }
        return null;
    }
...
class SkipPipeline {
     ...
     */
    constructor(previousPipeline, n) {
        this.mayChangeNumberOfElements = true;
        /**
         * The number of elements to skip.
         */
        _SkipPipeline_n.set(this, void 0);
        /**
         * The number of skipped elements.
         */
        _SkipPipeline_nbSkipped.set(this, 0);
        if (n < 0) {
            throw new Error("n must be >= 0");
        }
        this.previousPipeline = previousPipeline;
        __classPrivateFieldSet(this, _SkipPipeline_n, n, "f");
    }
    *[(_SkipPipeline_n = new WeakMap(), _SkipPipeline_nbSkipped = new WeakMap(), Symbol.iterator)]() {
        var _a;
        for (const e of this.previousPipeline) {
            if (__classPrivateFieldGet(this, _SkipPipeline_nbSkipped, "f") >= __classPrivateFieldGet(this, _SkipPipeline_n, "f")) {
                yield e;
            }
            __classPrivateFieldSet(this, _SkipPipeline_nbSkipped, (_a = __classPrivateFieldGet(this, _SkipPipeline_nbSkipped, "f"), _a++, _a), "f");
        }
        return null;
    }
    close() {
...
/***/ "./modules/streams/_stream-impl.ts":
/*!*****************************************!*\
  !*** ./modules/streams/_stream-impl.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types */ "./modules/streams/types.ts");
/* harmony import */ var _pipeline__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_pipeline */ "./modules/streams/_pipeline.ts");
var __classPrivateFieldSet = (undefined && undefined.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
...
class StreamImpl {
     ...
     */
    constructor(iterable, isPipeline = false) {
        /**
         * The last operation in the pipeline.
         */
        _StreamImpl_pipeline.set(this, void 0);
        if (isPipeline) {
            __classPrivateFieldSet(this, _StreamImpl_pipeline, iterable, "f");
        }
        else {
            __classPrivateFieldSet(this, _StreamImpl_pipeline, new _pipeline__WEBPACK_IMPORTED_MODULE_1__.SourcePipeline(iterable), "f");
        }
    }
    /*
     ...
     */
    filter(predicate) {
        __classPrivateFieldSet(this, _StreamImpl_pipeline, new _pipeline__WEBPACK_IMPORTED_MODULE_1__.FilterPipeline(__classPrivateFieldGet(this, _StreamImpl_pipeline, "f"), predicate), "f");
        return this;
    }
    map(mapper) {
        return new StreamImpl(new _pipeline__WEBPACK_IMPORTED_MODULE_1__.MapPipeline(__classPrivateFieldGet(this, _StreamImpl_pipeline, "f"), mapper), true);
    }
    flatMap(mapper) {
        return new StreamImpl(new _pipeline__WEBPACK_IMPORTED_MODULE_1__.FlatMapPipeline(__classPrivateFieldGet(this, _StreamImpl_pipeline, "f"), mapper), true);
    }
    distinct() {
        __classPrivateFieldSet(this, _StreamImpl_pipeline, new _pipeline__WEBPACK_IMPORTED_MODULE_1__.DistinctPipeline(__classPrivateFieldGet(this, _StreamImpl_pipeline, "f")), "f");
        return this;
    }
    sorted(comparator) {
        __classPrivateFieldSet(this, _StreamImpl_pipeline, new _pipeline__WEBPACK_IMPORTED_MODULE_1__.SortedPipeline(__classPrivateFieldGet(this, _StreamImpl_pipeline, "f"), comparator), "f");
        return this;
    }
    peek(action) {
        __classPrivateFieldSet(this, _StreamImpl_pipeline, new _pipeline__WEBPACK_IMPORTED_MODULE_1__.PeekPipeline(__classPrivateFieldGet(this, _StreamImpl_pipeline, "f"), action), "f");
        return this;
    }
    limit(maxSize) {
        __classPrivateFieldSet(this, _StreamImpl_pipeline, new _pipeline__WEBPACK_IMPORTED_MODULE_1__.LimitPipeline(__classPrivateFieldGet(this, _StreamImpl_pipeline, "f"), maxSize), "f");
        return this;
    }
    skip(n) {
        __classPrivateFieldSet(this, _StreamImpl_pipeline, new _pipeline__WEBPACK_IMPORTED_MODULE_1__.SkipPipeline(__classPrivateFieldGet(this, _StreamImpl_pipeline, "f"), n), "f");
        return this;
    }
    /*
     * Terminal operations
     */
    *toGenerator() {
        for (const e of __classPrivateFieldGet(this, _StreamImpl_pipeline, "f")) {
            yield e;
        }
        __classPrivateFieldGet(this, _StreamImpl_pipeline, "f").close();
        return null;
    }
    forEach(action) {
        for (const e of __classPrivateFieldGet(this, _StreamImpl_pipeline, "f")) {
    ...
    toArray() {
        const values = [...__classPrivateFieldGet(this, _StreamImpl_pipeline, "f")];
        __classPrivateFieldGet(this, _StreamImpl_pipeline, "f").close();
        return values;
    }
    ...
    min(comparator = StreamImpl.DEFAULT_COMPARATOR) {
        let anyFound = false;
        let min = null;
        for (const e of __classPrivateFieldGet(this, _StreamImpl_pipeline, "f")) {
            if (!anyFound) {
        ...
        return anyFound ? _types__WEBPACK_IMPORTED_MODULE_0__.Optional.of(min) : _types__WEBPACK_IMPORTED_MODULE_0__.Optional.empty();
    }
    max(comparator = StreamImpl.DEFAULT_COMPARATOR) {
        let anyFound = false;
        let max = null;
        for (const e of __classPrivateFieldGet(this, _StreamImpl_pipeline, "f")) {
            if (!anyFound) {
        ...
        return anyFound ? _types__WEBPACK_IMPORTED_MODULE_0__.Optional.of(max) : _types__WEBPACK_IMPORTED_MODULE_0__.Optional.empty();
    }
    count() {
        let pipeline = __classPrivateFieldGet(this, _StreamImpl_pipeline, "f");
        // OPTIMIZATION:
        ...
        while (!(pipeline instanceof _pipeline__WEBPACK_IMPORTED_MODULE_1__.SourcePipeline) && !pipeline.mayChangeNumberOfElements) {
        ...
        if (pipeline instanceof _pipeline__WEBPACK_IMPORTED_MODULE_1__.SourcePipeline) {
    ...
    findFirst() {
        ...
        for (const e of __classPrivateFieldGet(this, _StreamImpl_pipeline, "f")) {
            __classPrivateFieldGet(this, _StreamImpl_pipeline, "f").close();
            return _types__WEBPACK_IMPORTED_MODULE_0__.Optional.of(e);
        }
        return _types__WEBPACK_IMPORTED_MODULE_0__.Optional.empty();
    }
    sum() {
        let sum = 0;
        for (const e of __classPrivateFieldGet(this, _StreamImpl_pipeline, "f")) {
    ...
    average() {
        ...
        __classPrivateFieldGet(this, _StreamImpl_pipeline, "f").close();
        return nb !== 0 ? _types__WEBPACK_IMPORTED_MODULE_0__.Optional.of(sum / nb) : _types__WEBPACK_IMPORTED_MODULE_0__.Optional.empty();
    }
    join(joiner) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Optional: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_1__.Optional),
/* harmony export */   emptyStream: () => (/* binding */ emptyStream),
/* harmony export */   stream: () => (/* binding */ stream),
/* harmony export */   streamOfObject: () => (/* binding */ streamOfObject)
/* harmony export */ });
/* harmony import */ var _stream_impl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_stream-impl */ "./modules/streams/_stream-impl.ts");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types */ "./modules/streams/types.ts");
...
function emptyStream() {
    return _stream_impl__WEBPACK_IMPORTED_MODULE_0__.StreamImpl.for([]);
}
/**
...
function stream(iterable) {
    return _stream_impl__WEBPACK_IMPORTED_MODULE_0__.StreamImpl.for(iterable);
}
/**
 ...
 * @returns The new {@link types.Stream}.
 */
function streamOfObject(o) {
    return _stream_impl__WEBPACK_IMPORTED_MODULE_0__.StreamImpl.for(objectIterator(o));
}
/**
...
var _a, _Optional_EMPTY, _Optional_value;
/**
...
class Optional {
     ...
     */
    static empty() {
        return __classPrivateFieldGet(this, _a, "f", _Optional_EMPTY);
    }
    /**
    ...
    constructor(value) {
         ...
         * The wrapped value.
         */
        _Optional_value.set(this, void 0);
        __classPrivateFieldSet(this, _Optional_value, value, "f");
    }
    /**
    ...
    get() {
        ...
        return __classPrivateFieldGet(this, _Optional_value, "f");
    }
    /**
     * If a value is not present, return `true`, otherwise `false`.
     */
    isEmpty() {
        return __classPrivateFieldGet(this, _Optional_value, "f") === null || __classPrivateFieldGet(this, _Optional_value, "f") === undefined;
    }
    /**
     ...
     */
    ifPresent(action, emptyAction) {
        if (this.isPresent()) {
            action(__classPrivateFieldGet(this, _Optional_value, "f"));
        }
        else {
            emptyAction === null || emptyAction === void 0 ? void 0 : emptyAction();
        }
    }
    /**
     ...
     */
    filter(predicate) {
        return this.isPresent() && predicate(__classPrivateFieldGet(this, _Optional_value, "f")) ? this : _a.empty();
    }
    /**
     ...
     */
    map(mapper) {
        return this.isPresent() ? _a.ofNullable(mapper(__classPrivateFieldGet(this, _Optional_value, "f"))) : _a.empty();
    }
    /**
    ...
    flatMap(mapper) {
        ...
        const optional = mapper(__classPrivateFieldGet(this, _Optional_value, "f"));
        if (!optional) {
    ...
    toString() {
        return `Optional[${__classPrivateFieldGet(this, _Optional_value, "f")}]`;
    }
}
_a = Optional, _Optional_value = new WeakMap();
/**
 * The singleton instance of the empty {@link Optional}.
 */
_Optional_EMPTY = { value: new _a() };
...
/* harmony export */   OTTM: () => (/* binding */ OTTM)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! js-cookie */ "./node_modules/js-cookie/dist/js.cookie.mjs");
/* harmony import */ var _streams__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./streams */ "./modules/streams/index.ts");
var __classPrivateFieldSet = (undefined && undefined.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
...
var _Mapping_mappings, _OTTM_instances, _OTTM_setReturnTo;
...
class Mapping {
     ...
     */
    constructor(data) {
        _Mapping_mappings.set(this, void 0);
        __classPrivateFieldSet(this, _Mapping_mappings, data, "f");
    }
    /**
     ...
     */
    get(key) {
        return __classPrivateFieldGet(this, _Mapping_mappings, "f")[key];
    }
    /**
     ...
     */
    keys() {
        return Object.keys(__classPrivateFieldGet(this, _Mapping_mappings, "f"));
    }
    /**
     * @return An array of all values of this object.
     */
    values() {
        return Object.values(__classPrivateFieldGet(this, _Mapping_mappings, "f"));
    }
    /**
     * @return An array of all key-value entries of this object.
     */
    entries() {
        return Object.entries(__classPrivateFieldGet(this, _Mapping_mappings, "f"));
    }
    /**
     * @return An iterator over the entries of this object.
     */
    [(_Mapping_mappings = new WeakMap(), Symbol.iterator)]() {
...
class OTTM {
    constructor() {
        ...
        for (const langData of window.OTTM_CONFIG.languages) {
            langs[langData.code] = new Language(langData.code, langData.name, langData.writingDirection, langData.comma, langData.and, langData.dayNames, langData.abbrDayNames, langData.monthNames, langData.abbrMonthNames, langData.ampm, langData.decimalSep, langData.thousandsSep);
        }
        this.languages = new Mapping(langs);
        delete window.OTTM_CONFIG;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#ottm-config-script").remove();
    }
    /**
     ...
     */
    translate(key, defaultValue, formatArgs = {}) {
        var _a, _b;
        let text = (_b = (_a = this.translations.get(key)) !== null && _a !== void 0 ? _a : (defaultValue instanceof Function ? defaultValue() : defaultValue)) !== null && _b !== void 0 ? _b : key;
        if (text) {
     ...
     */
    formatShortcut(...keys) {
        return _streams__WEBPACK_IMPORTED_MODULE_2__.stream(keys)
    ...
    setReferrer() {
        ...
        for (const linkSelector of linkSelectors) {
            const $link = jquery__WEBPACK_IMPORTED_MODULE_0___default()(linkSelector);
            if ($link.length) {
                __classPrivateFieldGet(this, _OTTM_instances, "m", _OTTM_setReturnTo).call(this, $link, path);
            }
        }
    }
    /**
    ...
    getCookie(name, defaultValue) {
        var _a;
        return (_a = js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].get(name)) !== null && _a !== void 0 ? _a : defaultValue;
    }
    /**
    ...
    setCookie(name, value, options) {
        js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].set(name, value, options);
    }
    /**
     * Delete a cookie.
     * @param name Cookie’s name.
    ...
    deleteCookie(name, options) {
        js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].remove(name, options);
    }
}
_OTTM_instances = new WeakSet(), _OTTM_setReturnTo = function _OTTM_setReturnTo($link, path, args) {
    const url = new URL($link.prop("href"));
    const params = new URLSearchParams({ return_to: path });
    if (args) {
        for (const [k, v] of Object.entries(args)) {
            params.append(k, v !== null && v !== void 0 ? v : "");
        }
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ initEditor)
/* harmony export */ });
/**
...
function initEditor() {
    ...
    }[window.ottm.page.get("wContentType")];
    ...
    $("#wiki-edit-form").on("submit", e => {
        const comment = $("#wiki-edit-form-comment").val().trim();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   WikiAPI: () => (/* binding */ WikiAPI),
/* harmony export */   WikiGadget: () => (/* binding */ WikiGadget),
/* harmony export */   WikiGadgetManager: () => (/* binding */ WikiGadgetManager),
/* harmony export */   "default": () => (/* binding */ initWiki)
/* harmony export */ });
/* harmony import */ var _editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_editor */ "./modules/wiki/_editor.ts");
var __classPrivateFieldSet = (undefined && undefined.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
...
var _WikiGadget_code, _WikiGadgetManager_instances, _WikiGadgetManager_gadgets, _WikiGadgetManager_gadgetsQueueSize, _WikiGadgetManager_finishedRegistration, _WikiGadgetManager_locked, _WikiGadgetManager_lock;
...
class WikiGadget {
    ...
    constructor(code) {
        ...
        _WikiGadget_code.set(this, void 0);
        if (!code.hasOwnProperty("name")) {
            throw new Error("Missing \"name\" property in gadget");
        }
        this.name = code.name;
        this.version = code.version;
        __classPrivateFieldSet(this, _WikiGadget_code, code, "f");
        __classPrivateFieldGet(this, _WikiGadget_code, "f").init();
    }
    /**
    ...
    run() {
        try {
            __classPrivateFieldGet(this, _WikiGadget_code, "f").run();
        }
        catch (e) {
            console.error(e);
            return false;
...
class WikiGadgetManager {
    ...
    registerGadget(gadgetName) {
        var _a;
        if (__classPrivateFieldGet(this, _WikiGadgetManager_locked, "f")) {
            throw new Error("Cannot register gadgets when manager is locked");
        }
        console.log(`Registering gadget "${gadgetName}…"`);
        __classPrivateFieldSet(this, _WikiGadgetManager_gadgetsQueueSize, (_a = __classPrivateFieldGet(this, _WikiGadgetManager_gadgetsQueueSize, "f"), _a++, _a), "f");
        ...
        $.get(apiPath, {
            ...
            try {
                ...
                __classPrivateFieldGet(this, _WikiGadgetManager_gadgets, "f")[gadget.name] = gadget;
            }
            catch (e) {
                console.error(`Error while loading gadget "${gadgetName}":\n${e}`);
            }
            __classPrivateFieldSet(this, _WikiGadgetManager_gadgetsQueueSize, (_a = __classPrivateFieldGet(this, _WikiGadgetManager_gadgetsQueueSize, "f"), _a--, _a), "f");
            if (__classPrivateFieldGet(this, _WikiGadgetManager_gadgetsQueueSize, "f") === 0 && __classPrivateFieldGet(this, _WikiGadgetManager_finishedRegistration, "f")) {
                __classPrivateFieldGet(this, _WikiGadgetManager_instances, "m", _WikiGadgetManager_lock).call(this);
            }
        });
    }
    /**
     ...
     */
    finishRegistration() {
        __classPrivateFieldSet(this, _WikiGadgetManager_finishedRegistration, true, "f");
        if (__classPrivateFieldGet(this, _WikiGadgetManager_gadgetsQueueSize, "f") === 0) {
            __classPrivateFieldGet(this, _WikiGadgetManager_instances, "m", _WikiGadgetManager_lock).call(this);
        }
    }
    /**
     ...
     */
    getGadget(name) {
        return __classPrivateFieldGet(this, _WikiGadgetManager_gadgets, "f")[name];
    }
    /**
    ...
    isGadgetRegistered(name) {
        return __classPrivateFieldGet(this, _WikiGadgetManager_gadgets, "f")[name] !== undefined;
    }
}
_WikiGadgetManager_gadgets = new WeakMap(), _WikiGadgetManager_gadgetsQueueSize = new WeakMap(), _WikiGadgetManager_finishedRegistration = new WeakMap(), _WikiGadgetManager_locked = new WeakMap(), _WikiGadgetManager_instances = new WeakSet(), _WikiGadgetManager_lock = function _WikiGadgetManager_lock() {
    __classPrivateFieldSet(this, _WikiGadgetManager_locked, true, "f");
};
/**
...
class WikiAPI {
     ...
     */
    getPageCategories(title, includeHidden = false) {
        // TODO
        return null;
    }
    /**
...
function initWiki() {
    ...
    if (action === "edit" || action === "submit") {
        (0,_editor__WEBPACK_IMPORTED_MODULE_0__["default"])();
    }
    else if (action === "talk") {
        // TODO
    }
...
"use strict";
/*!*******************************!*\
  !*** ./modules/index-wiki.ts ***!
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! js-cookie */ "./node_modules/js-cookie/dist/js.cookie.mjs");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./types */ "./modules/types.ts");
/* harmony import */ var _confirm_form_exit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_confirm-form-exit */ "./modules/_confirm-form-exit.ts");
/* harmony import */ var _wiki__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./wiki */ "./modules/wiki/index.ts");
/**
...
window.ottm = new _types__WEBPACK_IMPORTED_MODULE_2__.OTTM();
hookSettingsDropdownBehavior();
hookDarkModeCallback();
hookLanguageSelectorCallback();
initForms();
(0,_wiki__WEBPACK_IMPORTED_MODULE_4__["default"])();
...
function hookSettingsDropdownBehavior() {
    const $button = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#navbar-logged-out-settings");
    if ($button.length) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").on("click", e => {
            if (!jquery__WEBPACK_IMPORTED_MODULE_0___default().contains($parent[0], e.target)) {
...
function hookDarkModeCallback() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dark-mode-checkbox").on("click", e => {
        const checked = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).prop("checked");
        js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].set("dark_mode", checked);
        location.reload();
    });
}
function hookLanguageSelectorCallback() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#nav-language-select").on("change", e => {
        const langCode = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).val();
        js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].set('language', langCode);
        location.reload();
    });
}
function initForms() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("form div.form-group").each((_, element) => {
        const $e = jquery__WEBPACK_IMPORTED_MODULE_0___default()(element);
    ...
    if (location.pathname === "/sign-up") {
        passwordConfirm(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sign-up-form-password"), jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sign-up-form-password-confirm"));
    }
    else if (location.pathname === "/user/settings") {
        passwordConfirm(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#user-settings-form-password"), jquery__WEBPACK_IMPORTED_MODULE_0___default()("#user-settings-form-password-confirm"));
    }
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("form input[name='warn-unsaved']")
        .each((_, e) => (0,_confirm_form_exit__WEBPACK_IMPORTED_MODULE_3__["default"])(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).closest("form")));
}
/**
 * Add the shortcut to the title attribute of any element that has an access key.
 */
function setAccessKeys() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("*[accesskey]").each((_, element) => {
