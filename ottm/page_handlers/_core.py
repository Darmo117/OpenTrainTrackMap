    ...
    def __init__(
        ...
        self._js_config = {
            ...
            'user': {
                ...
                'preferedLanguage': self.user.prefered_language.code,
                'gender': self.user.gender.label,
                'usesDarkMode': self.user.uses_dark_mode,
                'preferedDatetimeFormat': self.user.prefered_datetime_format,
                'preferedTimezone': self.user.prefered_timezone.zone,
